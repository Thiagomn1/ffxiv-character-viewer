...
import type { CharacterDetail, GearItem } from "../types/character";
...
const isGearItem = (value: unknown): value is GearItem => {
...
export default function CharacterBannerDialog({
  ...
  const gearSlots: Array<keyof CharacterDetail> = [
    "Mainhand",
    "Head",
    "Body",
    "Hands",
                ...
                <div className="text-center">
                  ...
                  {character.FreeCompany ? (
                    <div className="flex flex-row items-center mt-1">
                      {character.FreeCompany.IconLayers?.Middle && (
                        <img
              ...
              <div className="flex flex-col md:w-2/3 bg-[#141414]/70 p-4 rounded-xl border border-[#2c2c2c] shadow-md overflow-y-auto max-h-[80vh]">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {gearSlots.map((slot) => {
                    ...
                    if (!isGearItem(gear)) return null;
                    return (
                      <div
                        key={slot}
